...
void Paxos::extend_lease()
{
  ...
  utime_mono_t lease_expire_mono = ceph_mono_clock_now(g_ceph_context);
  ...
  lease_expire_mono += g_conf->mon_lease_renew_interval;
  mon->timer.add_event_at(lease_expire_mono, lease_renew_event);
}
